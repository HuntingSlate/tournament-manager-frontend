...
import { useGetPlayerStatisticsFromGameQuery } from '@/src/api/mutations/leaderboardMutations';
...
export const ProfileDetailsGamesStatistics: FC = () => {
	...
	const { data: playerGameData, isLoading: playerGameLoading } =
		useGetPlayerStatisticsFromGameQuery(Number(selectedGame), Number(id));
